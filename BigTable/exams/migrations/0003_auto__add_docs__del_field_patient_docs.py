...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'exams', ['Docs'])

        # Deleting field 'Patient.docs'
        db.delete_column(u'exams_patient', 'docs')


    def backwards(self, orm):
        # Deleting model 'Docs'
        db.delete_table(u'exams_docs')


        # User chose to not deal with backwards NULL issues for 'Patient.docs'
        raise RuntimeError("Cannot reverse this migration. 'Patient.docs' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Patient.docs'
        db.add_column(u'exams_patient', 'docs',
