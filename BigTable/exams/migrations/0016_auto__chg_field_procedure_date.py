...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Procedure.date'
        db.alter_column(u'exams_procedure', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 18, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Procedure.date'
        db.alter_column(u'exams_procedure', 'date', self.gf('django.db.models.fields.DateField')(null=True))
