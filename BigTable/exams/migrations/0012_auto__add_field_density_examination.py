...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Density.examination'
        db.add_column(u'exams_density', 'examination',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['exams.Examination']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Density.examination'
        db.delete_column(u'exams_density', 'examination_id')
