...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'exams_patient', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=1),
                      keep_default=False)

        # Adding field 'Patient.final_diagnosis'
        db.add_column(u'exams_patient', 'final_diagnosis',
                      self.gf('django.db.models.fields.CharField')(default='norm', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.gender'
        db.delete_column(u'exams_patient', 'gender')

        # Deleting field 'Patient.final_diagnosis'
        db.delete_column(u'exams_patient', 'final_diagnosis')
