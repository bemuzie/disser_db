...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Examination.arterial_invasion_celiac'
        db.add_column(u'exams_examination', 'arterial_invasion_celiac',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Examination.arterial_invasion_messup'
        db.add_column(u'exams_examination', 'arterial_invasion_messup',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Examination.arterial_invasion_splen'
        db.add_column(u'exams_examination', 'arterial_invasion_splen',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Examination.arterial_invasion_hep'
        db.add_column(u'exams_examination', 'arterial_invasion_hep',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Examination.arterial_invasion_other'
        db.add_column(u'exams_examination', 'arterial_invasion_other',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Examination.arterial_invasion_celiac'
        db.delete_column(u'exams_examination', 'arterial_invasion_celiac')

        # Deleting field 'Examination.arterial_invasion_messup'
        db.delete_column(u'exams_examination', 'arterial_invasion_messup')

        # Deleting field 'Examination.arterial_invasion_splen'
        db.delete_column(u'exams_examination', 'arterial_invasion_splen')

        # Deleting field 'Examination.arterial_invasion_hep'
        db.delete_column(u'exams_examination', 'arterial_invasion_hep')

        # Deleting field 'Examination.arterial_invasion_other'
        db.delete_column(u'exams_examination', 'arterial_invasion_other')
    ...
    models = {
        ...
        u'exams.examination': {
            ...
            'arterial_invasion_celiac': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'arterial_invasion_hep': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'arterial_invasion_messup': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'arterial_invasion_other': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'arterial_invasion_splen': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'exams.patient': {
            ...
            'final_diagnosis': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'exams.phase': {
            'Meta': {'ordering': "['time']", 'object_name': 'Phase'},
            'examination': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': u"orm['exams.Examination']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'zone': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        },
        u'exams.procedure': {
