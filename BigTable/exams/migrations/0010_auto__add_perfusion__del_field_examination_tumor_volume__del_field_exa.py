...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Perfusion'
        db.create_table(u'exams_perfusion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('roi', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('roi_size_max', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('roi_max_distance', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('roi_volume', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bf_mean', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bf_sd', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bf_median', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bf_quantile_low', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bf_quantile_up', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bv_mean', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bv_sd', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bv_median', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bv_quantile_low', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bv_quantile_up', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mtt_mean', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mtt_sd', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mtt_median', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mtt_quantile_low', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mtt_quantile_up', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('ttp', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'exams', ['Perfusion'])
    ...
    def backwards(self, orm):
        # Deleting model 'Perfusion'
        db.delete_table(u'exams_perfusion')
