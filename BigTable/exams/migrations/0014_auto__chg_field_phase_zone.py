...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Phase.zone'
        db.alter_column(u'exams_phase', 'zone', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'Phase.zone'
        db.alter_column(u'exams_phase', 'zone', self.gf('django.db.models.fields.CharField')(max_length=10))
