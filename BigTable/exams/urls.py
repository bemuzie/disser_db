...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<patient_id>\d+)/(?P<examination_id>\d+)/modify_examination', views.modify_examination,
                           name='modify_examination'),
                       # Изменение исследования, добавление временных задержек, описание результатов исследования
                       url(r'^(?P<patient_id>\d+)/(?P<examination_id>\d+)/modify_phase', views.modify_phase,
                           name='modify_phase'),
                       # добавление, удаление, изменение временных задержек и зоны сканирования каждой фазы исследования
                       url(r'^(?P<patient_id>\d+)/(?P<examination_id>\d+)/actions_examination',
                           views.actions_examination, name='actions_examination'),
                       ...
                       url(r'^(?P<patient_id>\d+)/(?P<examination_id>\d+)/perfetc/', include('perfetc.urls'),
                           name='add_detail'),
